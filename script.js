const SITE_URL = 'https://imperfectu.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Imperfectu — Sonic Remedy | Soozhee',
        text: 'Imperfectu by Soozhee. Sonic Remedy : Audiosensory Resonance | Alien Frequencies.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
